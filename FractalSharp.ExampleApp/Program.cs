...
namespace FractalSharp.ExampleApp
{
    ...
    class Program
    {
        ...
        private static readonly FractalProcessor<SquareMandelbrotAlgorithm<Float128<TAccelerator>, DefaultNumberConverter<TAccelerator>>, SquareMandelbrotAlgorithmParams<Float128<TAccelerator>>, Float128<TAccelerator>> FractalProcessor =
            new GPUFractalProcessor<SquareMandelbrotAlgorithm<Float128<TAccelerator>, DefaultNumberConverter<TAccelerator>>, SquareMandelbrotAlgorithmParams<Float128<TAccelerator>>, Float128<TAccelerator>>(WIDTH, HEIGHT);
