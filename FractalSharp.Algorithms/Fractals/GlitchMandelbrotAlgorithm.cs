...
{
    public record struct GlitchMandelbrotAlgorithmParams<TNumber> :
        ...
        unmanaged, IFloatingPointIeee754<TNumber>
    {
        ...
        public GlitchMandelbrotAlgorithmParams()
        {
            MaxIterations = 256;
    ...
    public class GlitchMandelbrotAlgorithm<TNumber, TConverter> :
        IFractalProvider<GlitchMandelbrotAlgorithmParams<TNumber>, TNumber>
        ...
        where TConverter : struct, INumberConverter<TNumber>
    {
        ...
        public static Rectangle<TNumber> GetOutputBounds(GlitchMandelbrotAlgorithmParams<TNumber> @params, TNumber aspectRatio)
        {
        ...
        public static PointData<double> Run(GlitchMandelbrotAlgorithmParams<TNumber> @params, Complex<TNumber> c)
        {
            int iter = 0;
            ...
            for (; iter < @params.MaxIterations; iter++)
            {
                ...
                imag = _two * real * imag + c.Imag;

                z = new Complex<TNumber>(real, imag);
            }
