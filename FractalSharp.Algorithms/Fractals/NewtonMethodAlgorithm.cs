...
{
    public record struct NewtonMethodAlgorithmParams<TNumber> :
    ...
    public class NewtonMethodAlgorithm<TNumber, TConverter> :
        IFractalProvider<NewtonMethodAlgorithmParams<TNumber>, TNumber>
        ...
        where TConverter : struct, INumberConverter<TNumber>
    {
        ...
        public static Rectangle<TNumber> GetOutputBounds(NewtonMethodAlgorithmParams<TNumber> @params, TNumber aspectRatio)
        {
        ...
        public static PointData<double> Run(NewtonMethodAlgorithmParams<TNumber> @params, Complex<TNumber> z)
        {
            int iter = 0;
            ...
            return new PointData<double>(new Complex<double>(doubleReal, doubleImag), iter, PointClass.Outer);
        }
    }
}
