...
{
    public record struct BurningShipAlgorithmParams<TNumber> :
        ...
        unmanaged, IFloatingPointIeee754<TNumber>
    {
        ...
        public BurningShipAlgorithmParams()
        {
            MaxIterations = 256;
    ...
    public class BurningShipAlgorithm<TNumber, TConverter> :
        IFractalProvider<BurningShipAlgorithmParams<TNumber>, TNumber>
        ...
        where TConverter : struct, INumberConverter<TNumber>
    {
        ...
        public static Rectangle<TNumber> GetOutputBounds(BurningShipAlgorithmParams<TNumber> @params, TNumber aspectRatio)
        {
        ...
        public static PointData<double> Run(BurningShipAlgorithmParams<TNumber> @params, Complex<TNumber> c)
        {
            int iter = 0;
            ...
            for (; iter < @params.MaxIterations; iter++)
            {
                ...
                Complex<TNumber> zValue = new Complex<TNumber>(TNumber.Abs(z.Real), TNumber.Abs(z.Imag));
                z = zValue * zValue + c;
            }
